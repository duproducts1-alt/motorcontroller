...
#define MAX_APPLICATION_SPEED_RPM           2994 /*!< rpm, mechanical */
...
#define PID_SPEED_KP_DEFAULT                3077/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                79/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_TARGET_SPEED_RPM            1078
...
/* Phase 2 */
#define PHASE2_DURATION                     2396 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT             (1198*SPEED_UNIT/U_RPM)
#define PHASE2_FINAL_CURRENT_A              5

/* Phase 3 */
#define PHASE3_DURATION                     0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT             (1198*SPEED_UNIT/U_RPM)
#define PHASE3_FINAL_CURRENT_A              5

/* Phase 4 */
#define PHASE4_DURATION                     0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT             (1198*SPEED_UNIT/U_RPM)
#define PHASE4_FINAL_CURRENT_A              5

/* Phase 5 */
#define PHASE5_DURATION                     0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT             (1198*SPEED_UNIT/U_RPM)
...
#define OBS_MINIMUM_SPEED_RPM               1078
